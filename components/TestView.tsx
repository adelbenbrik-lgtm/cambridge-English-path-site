...
const TestView: React.FC<TestViewProps> = ({ level, module, onTestComplete, onBack }) => {
    ...
    if (isLoading) return <div className="text-center p-8"><LoadingSpinner /> <p className="mt-4 text-lg text-black">Generating your test...</p></div>;
    ...
    if (showResults) {
        ...
        return (
            <div className="bg-white p-8 rounded-xl shadow-lg text-center max-w-lg mx-auto">
                ...
                {passed ? (
                    <>
                        <p className="text-xl text-black mb-6">Congratulations! You've passed the {module.name} test.</p>
                    ...
                    <>
                        <p className="text-xl text-black mb-6">You need {PASS_PERCENTAGE * 100}% to pass. Please review the material and try again.</p>
    ...
    return (
        <div className="bg-white p-6 sm:p-8 rounded-xl shadow-lg max-w-2xl mx-auto">
            ...
            <p className="text-black mb-6">Question {currentQuestionIndex + 1} of {questions.length}</p>
            
            <div className="border-t pt-6">
                <p className="text-xl font-semibold mb-6 text-black">{currentQuestion.question}</p>
                        ...
                        <button
                            ...
                            className={`w-full text-left p-4 rounded-lg border-2 transition-colors ${
                                answers[currentQuestionIndex] === option
                                    ...
                                    : 'bg-gray-100 border-gray-200 hover:border-cambridge-blue text-black'
                            }`}
                        >
                            {option}
                        </button>
